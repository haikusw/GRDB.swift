...
**Latest release**: January 17, 2020 • version 4.9.0 • [CHANGELOG](CHANGELOG.md) • [Migrating From GRDB 3 to GRDB 4](Documentation/GRDB3MigrationGuide.md)

**Requirements**: iOS 9.0+ / macOS 10.9+ / tvOS 9.0+ / watchOS 2.0+ &bull; Swift 5.1+ / Xcode 11.0+

| Swift version | GRDB version                                                |
| ------------- | ----------------------------------------------------------- |
| **Swift 5.1** | **v4.9.0**                                                  |
| Swift 5       | [v4.9.0](https://github.com/groue/GRDB.swift/tree/v4.9.0)   |
| Swift 4.2     | [v4.9.0](https://github.com/groue/GRDB.swift/tree/v4.9.0)   |
...
- [GRDB Reference](http://groue.github.io/GRDB.swift/docs/4.9/index.html) (generated by [Jazzy](https://github.com/realm/jazzy))
...
See [Configuration](http://groue.github.io/GRDB.swift/docs/4.9/Structs/Configuration.html) for more details.
...
See [Values](#values) for more information on supported arguments types (Bool, Int, String, Date, Swift enums, etc.), and [StatementArguments](http://groue.github.io/GRDB.swift/docs/4.9/Structs/StatementArguments.html) for a detailed documentation of SQLite arguments.
...
Values can be used as [statement arguments](http://groue.github.io/GRDB.swift/docs/4.9/Structs/StatementArguments.html):
...
Transactions can't be left opened unless you set the [allowsUnsafeTransactions](http://groue.github.io/GRDB.swift/docs/4.9/Structs/Configuration.html) configuration flag:
...
Row adapters are values that adopt the [RowAdapter](http://groue.github.io/GRDB.swift/docs/4.9/Protocols/RowAdapter.html) protocol. You can implement your own custom adapters ([**:fire: EXPERIMENTAL**](#what-are-experimental-features)), or use one of the four built-in adapters, described below.
...
See [fetching methods](#fetching-methods) for information about the `fetchCursor`, `fetchAll` and `fetchOne` methods. See [StatementArguments](http://groue.github.io/GRDB.swift/docs/4.9/Structs/StatementArguments.html) for more information about the query arguments.
...
See [DatabaseDateDecodingStrategy](https://groue.github.io/GRDB.swift/docs/4.9/Enums/DatabaseDateDecodingStrategy.html), [DatabaseDateEncodingStrategy](https://groue.github.io/GRDB.swift/docs/4.9/Enums/DatabaseDateEncodingStrategy.html), and [DatabaseUUIDEncodingStrategy](https://groue.github.io/GRDB.swift/docs/4.9/Enums/DatabaseUUIDEncodingStrategy.html) to learn about all available strategies.
...
Raw SQL snippets are also accepted, with eventual [arguments](http://groue.github.io/GRDB.swift/docs/4.9/Structs/StatementArguments.html):
...
- [SQLRequest](http://groue.github.io/GRDB.swift/docs/4.9/Structs/SQLRequest.html) is a fetch request built from raw SQL. For example:
...
- [AnyFetchRequest](http://groue.github.io/GRDB.swift/docs/4.9/Structs/AnyFetchRequest.html): a [type-erased](http://chris.eidhof.nl/post/type-erasers-in-swift/) request.
...
**[DatabaseRegion](https://groue.github.io/GRDB.swift/docs/4.9/Structs/DatabaseRegion.html) is a type that helps observing changes in the results of a database [request](#requests)**.
...
For more details, see the [reference](http://groue.github.io/GRDB.swift/docs/4.9/Structs/DatabaseRegion.html#/s:4GRDB14DatabaseRegionV10isModified2bySbAA0B5EventV_tF).
...
Both DatabaseQueue and DatabasePool adopt the [DatabaseReader](http://groue.github.io/GRDB.swift/docs/4.9/Protocols/DatabaseReader.html) and [DatabaseWriter](http://groue.github.io/GRDB.swift/docs/4.9/Protocols/DatabaseWriter.html) protocols. DatabaseSnapshot adopts DatabaseReader only.
...
- [@alextrob](https://github.com/alextrob), [@bellebethcooper](https://github.com/bellebethcooper), [@bfad](https://github.com/bfad), [@cfilipov](https://github.com/cfilipov), [@charlesmchen-signal](https://github.com/charlesmchen-signal), [@Chiliec](https://github.com/Chiliec), [@chrisballinger](https://github.com/chrisballinger), [@darrenclark](https://github.com/darrenclark), [@davidkraus](https://github.com/davidkraus), [@fpillet](http://github.com/fpillet), [@gjeck](https://github.com/gjeck), [@gusrota](https://github.com/gusrota), [@hartbit](https://github.com/hartbit), [@kdubb](https://github.com/kdubb), [@kluufger](https://github.com/kluufger), [@KyleLeneau](https://github.com/KyleLeneau), [@Marus](https://github.com/Marus), [@MaxDesiatov](https://github.com/MaxDesiatov), [@michaelkirk-signal](https://github.com/michaelkirk-signal), [@pakko972](https://github.com/pakko972), [@peter-ss](https://github.com/peter-ss), [@pierlo](https://github.com/pierlo), [@pocketpixels](https://github.com/pocketpixels), [@robcas3](https://github.com/robcas3), [@runhum](https://github.com/runhum), [@schveiguy](https://github.com/schveiguy), [@SD10](https://github.com/SD10), [@sobri909](https://github.com/sobri909), [@sroddy](https://github.com/sroddy), [@swiftlyfalling](https://github.com/swiftlyfalling), [@Timac](https://github.com/Timac), [@valexa](https://github.com/valexa), and [@zmeyc](https://github.com/zmeyc) for their contributions, help, and feedback on GRDB.
